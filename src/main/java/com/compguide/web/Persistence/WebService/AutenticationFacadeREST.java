...
public class AutenticationFacadeREST extends AbstractFacade<Autentication> {
    ...
    public AutenticationFacadeREST() {
    ...
    public void create(Autentication entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Autentication entity) {
        super.edit(entity);
    }
    ...
    public Autentication find(@PathParam("id") Integer id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Autentication> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Autentication> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
