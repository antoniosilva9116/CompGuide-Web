...
public class TemporalElementFacadeREST extends AbstractFacade<TemporalElement> {
    ...
    public TemporalElementFacadeREST() {
    ...
    public void create(TemporalElement entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, TemporalElement entity) {
        super.edit(entity);
    }
    ...
    public TemporalElement find(@PathParam("id") Integer id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TemporalElement> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<TemporalElement> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
