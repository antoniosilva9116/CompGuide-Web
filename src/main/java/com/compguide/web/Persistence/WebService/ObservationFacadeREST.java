 ...
 */
@Stateless
@Path("com.compguide.web.persistence.entities.observation")
public class ObservationFacadeREST extends AbstractFacade<Observation> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Observation entity) {
        super.edit(entity);
    }
    ...
    public Observation find(@PathParam("id") Integer id) {
