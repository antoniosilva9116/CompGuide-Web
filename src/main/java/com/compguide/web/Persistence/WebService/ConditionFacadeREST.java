...
public class ConditionFacadeREST extends AbstractFacade<Condition> {
    ...
    public void create(Condition entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Condition entity) {
        super.edit(entity);
    }
    ...
    public Condition find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Condition> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
