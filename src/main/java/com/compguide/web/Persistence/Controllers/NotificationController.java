...
public class NotificationController implements Serializable {
    ...
    @EJB
    private com.compguide.web.Persistence.SessionBeans.NotificationFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("NotificationCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("NotificationUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("NotificationDeleted"));
        if (!JsfUtil.isValidationFailed()) {
