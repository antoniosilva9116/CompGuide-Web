...
import com.compguide.web.Persistence.Entities.Exam;
...
import com.compguide.web.Persistence.SessionBeans.ExamFacade;
...
public class ExamController implements Serializable {
    ...
    @EJB
    private com.compguide.web.Persistence.SessionBeans.ExamFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resources/Bundle").getString("ExamCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resources/Bundle").getString("ExamUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resources/Bundle").getString("ExamDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ExamControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Exam) {
                Exam o = (Exam) object;
                return getStringKey(o.getIdexam());
            } else {
