...
public class Guideexec_1 {
    ...
    public static Guideexec_1 fromJson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, Guideexec_1.class);
    }

    public static Guideexec_1 fromBean(GuideexecBean bean) {
        Guideexec_1 guideexec = new Guideexec_1();
